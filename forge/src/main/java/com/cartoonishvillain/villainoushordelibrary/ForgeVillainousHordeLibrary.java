...
public class ForgeVillainousHordeLibrary {

    public static final Logger LOGGER = LogUtils.getLogger();
    public ForgeVillainousHordeLibrary() {
    ...
    public void onServerStarting(ServerStartingEvent event)
    {
        ...
        try {
            ...
            ForgeVillainousHordeLibrary.LOGGER.warn("VillainousHordeLibrary - hordeJsonData.json not found! No Json hordes are loaded!");
        }
    }
