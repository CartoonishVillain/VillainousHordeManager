...
public class TypeHordeMovementGoal<T extends PathfinderMob> extends Goal {
    private final T Member;
    private final EntityTypeHorde hordeInstance;
    private final double movementModifier;

    public TypeHordeMovementGoal(T member, EntityTypeHorde hordeInstance, Double movementModifier){
        this.Member = member;
